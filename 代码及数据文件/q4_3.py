...
sheet1.title = "问题3重写"
sheet1.append(["次品率","是否检测零件1","是否检测零件2","是否检测零件3","是否检测零件4","是否检测零件5","是否检测零件6","是否检测零件7","是否检测零件8","是否检测半成品1",
               "是否检测半成品2","是否检测半成品3","是否拆解半成品1","是否拆解半成品2","是否拆解半成品3","是否检测成品","是否拆解成品","利润"])
...
for i in range(17):
    ...
    print(bestx,bestw)
    l = [bool(e) for e in bestx]
    l.append(bestw)  # type: ignore
    l.insert(0,a11)  # type: ignore
    sheet1.append(l)
    a11+=0.01
    a21+=0.01
    a31+=0.01
